...
################################################################
# This is a generated script based on design: zedboard_rocketchip
#
...
# source zedboard_rocketchip_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {100.00000} CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.preset {ZedBoard*}  ] $processing_system7_0
